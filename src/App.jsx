...
function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-50 border-b border-slate-200 transition ${isScrolled
...
function TeamSection() {
  return (
    <section className="space-y-3">
      ...
      <p className="text-sm text-slate-600">In their individual professional careers, our team members have previously worked with:</p>
      <CarouselDemo />
    </section>
  )
}
